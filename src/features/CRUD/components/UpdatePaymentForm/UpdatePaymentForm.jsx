...
function UpdatePaymentForm({ onSubmit, payment }) {
  const classes = useStyles();

  const schema = yup.object().shape({
    name: yup.string().required('Please enter payment name.'),

    type: yup.string().required('Please enter url of payment thumbnail.'),
  });
  ...
  return (
    <div className={classes.root}>
      ...
      <h3 className={classes.title}>Update Payment</h3>

      <form onSubmit={form.handleSubmit(handleUpdatePayment)}>
