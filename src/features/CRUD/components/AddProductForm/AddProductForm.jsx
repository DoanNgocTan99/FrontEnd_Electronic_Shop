...
import SelectFieldBrand from 'components/form-controls/SelectField/index_brand';
...
function AddProductForm({ onSubmit }) {
  ...
  const schema = yup.object().shape({
    ...
    avt: yup.string().required('Please enter url of product thumbnail.'),
  ...
  return (
    <div className={classes.root}>
      ...
      <form onSubmit={form.handleSubmit(handleAddProduct)}>
        ...
        <InputField name="avt" label="Thumbnail URL" form={form} />
        <InputField name="description" label="Description" form={form} />
        <SelectFieldBrand name="brand.id" label="Brand" form={form} />
        <InputField name="product_Price" label="Price" form={form} />
